module SendMessage::sendMessage {
    ...
    use std::signer;                              //signer who make the contract
    ...
    public entry fun store_message(account: &signer, msg: String) acquires Message{      // this will store message
    ...
    #[test(admin = @0x1234)]
    public entry fun test_store_message(admin: signer) acquires Message {         //creating new user 29
        account::create_account_for_test(signer::address_of(&admin));
        store_message(&admin, utf8(b"Hello for the first time!"));               // calling message
